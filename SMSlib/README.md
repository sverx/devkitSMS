...
GG_setColor(color)                                 /* macro - set color */
...
void SMS_loadSTC0compressedTilesatAddr (const void *src, unsigned int dst)
void SMS_loadSTC4compressedTilesatAddr (const void *src, unsigned int dst)
...
/* macros to load a tilemap column */
